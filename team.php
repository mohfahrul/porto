    ...
    <div class="container py-3">
        ...
        <div class="row row-cols-1 row-cols-md-4 g-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Sasono</h5>
                                    <p class="card-text">Senior Software Engineer</p>
                                    <a href="/detail/sasono.php" class="btn btn-primary stretched-link">Detail</a>
                                </div>
                            </div>
                        </div>
            <div class="col">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Tajudda Adi Negara</h5>
                        <p class="card-text">Associate Software Engineer</p>
                        <a href="/detail/judda.php" class="btn btn-primary stretched-link">Detail</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Dedi Ananto</h5>
                        <p class="card-text">Software Engineer</p>
                        <a href="/detail/dedi.php" class="btn btn-primary stretched-link">Detail</a>
                    </div>
                </div>
            </div>
            <div class="col">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Software Engineer</p>
                        <a href="/detail/emanuel.php" class="btn btn-primary stretched-link">Detail</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Tri Anto Aldyansyah</h5>
                        <p class="card-text">Junior Software Engineer</p>
                        <a href="/detail/emanuel.php" class="btn btn-primary stretched-link">Detail</a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="/detail/porto.php" class="btn btn-primary stretched-link">Detail</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Ismi</h5>
                        <p class="card-text">Junior Software Engineer</p>
                        <a href="/detail/ismi.php" class="btn btn-primary stretched-link">Detail</a>
                    </div>
                </div>
            </div>
            <div class="col">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Sukmana</h5>
                        <p class="card-text">Software Engineer</p>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Fahrul</h5>
                        <p class="card-text">Software Engineer</p>
                        <a href="/detail/fahrul.php" class="btn btn-primary stretched-link">Detail</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Rizki Fatihah</h5>
                        <p class="card-text">Engineer Trainee</p>
                        <a href="/detail/rizkifatihah.php" class="btn btn-primary stretched-link">Detail</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Bayu Firmansyah</h5>
                        <p class="card-text">Software Engineer</p>
